package md.maib.bank.config.impl;

import jakarta.websocket.DecodeException;
import jakarta.websocket.EncodeException;
import md.maib.bank.config.AESCoder;
...
public class AESCoderImpl implements AESCoder {
    ...
    public String decode(String encodedData) throws DecodeException {
        try {
            String[] parts = encodedData.split(":");
            if (parts.length != 2) {
                throw new DecodeException("Invalid data format", "The encoded data should contain IV and encrypted data.");
            }
            ...
            throw new DecodeException("Error occurred while decrypting data", String.valueOf(e));
        }
    }
}
